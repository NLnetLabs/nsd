...
static const struct type_descriptor type_descriptors[] = {
	...
	TYPE("A", TYPE_A,
		read_a_rdata, write_generic_rdata, print_a_rdata,
		a_rdata_fields),
	TYPE("NS", TYPE_NS,
		read_ns_rdata, write_ns_rdata, print_ns_rdata,
		ns_rdata_fields),
	TYPE("MD", TYPE_MD,
		read_md_rdata, write_md_rdata, print_ns_rdata,
		md_rdata_fields),
	TYPE("MF", TYPE_MF,
		read_mf_rdata, write_mf_rdata, print_ns_rdata,
		mf_rdata_fields),
	TYPE("CNAME", TYPE_CNAME,
		read_cname_rdata, write_cname_rdata, print_ns_rdata,
		cname_rdata_fields),
	TYPE("SOA", TYPE_SOA,
		read_soa_rdata, write_soa_rdata, print_soa_rdata,
		soa_rdata_fields),
	TYPE("MB", TYPE_MB,
		read_mb_rdata, write_mb_rdata, print_ns_rdata,
		mb_rdata_fields),
	TYPE("MG", TYPE_MG,
		read_mg_rdata, write_mg_rdata, print_ns_rdata,
		mg_rdata_fields),
	TYPE("MR", TYPE_MR,
		read_mr_rdata, write_mr_rdata, print_ns_rdata,
		mr_rdata_fields),
	TYPE("NULL", TYPE_NULL,
		read_generic_rdata, write_generic_rdata, print_generic_rdata,
		generic_rdata_fields),
	TYPE("WKS", TYPE_WKS,
		read_wks_rdata, write_generic_rdata, print_wks_rdata,
		wks_rdata_fields),
	TYPE("PTR", TYPE_PTR,
		read_ptr_rdata, write_ptr_rdata, print_ns_rdata,
		ptr_rdata_fields),
	TYPE("HINFO", TYPE_HINFO,
		read_hinfo_rdata, write_generic_rdata, print_hinfo_rdata,
		hinfo_rdata_fields),
	TYPE("MINFO", TYPE_MINFO,
		read_minfo_rdata, write_minfo_rdata, print_minfo_rdata,
		minfo_rdata_fields),
	TYPE("MX", TYPE_MX,
		read_mx_rdata, write_mx_rdata, print_mx_rdata,
		mx_rdata_fields),
	TYPE("TXT", TYPE_TXT,
		read_txt_rdata, write_generic_rdata, print_txt_rdata,
		txt_rdata_fields),
	TYPE("RP", TYPE_RP,
	...
	TYPE("SRV", TYPE_SRV,
		read_srv_rdata, write_srv_rdata, print_srv_rdata,
		srv_rdata_fields),

	UNKNOWN_TYPE(34),

	TYPE("NAPTR", TYPE_NAPTR,
		read_naptr_rdata, write_naptr_rdata, print_naptr_rdata,
		naptr_rdata_fields),
	TYPE("KX", TYPE_KX,
		read_kx_rdata, write_kx_rdata, print_mx_rdata,
	 	kx_rdata_fields),
	TYPE("CERT", TYPE_CERT,
		read_cert_rdata, write_generic_rdata, print_cert_rdata,
		cert_rdata_fields),
	TYPE("A6", TYPE_A6,
		read_a6_rdata, write_generic_rdata, print_a6_rdata),
	TYPE("DNAME", TYPE_DNAME,
		read_dname_rdata, write_dname_rdata, print_ns_rdata,
		dname_rdata_fields),
	...
	TYPE("APL", TYPE_APL,
		read_apl_rdata, write_generic_rdata, print_apl_rdata,
		apl_rdata_fields),
	TYPE("DS", TYPE_DS,
		read_ds_rdata, write_generic_rdata, print_ds_rdata,
		ds_rdata_fields),
	TYPE("SSHFP", TYPE_SSHFP,
		read_sshfp_rdata, write_generic_rdata, print_sshfp_rdata,
		sshfp_rdata_fields),
	TYPE("IPSECKEY", TYPE_IPSECKEY,
		read_ipseckey_rdata, write_generic_rdata, print_ipseckey_rdata,
		ipseckey_rdata_fields),
	TYPE("RRSIG", TYPE_RRSIG,
		read_rrsig_rdata, write_generic_rdata, print_rrsig_rdata,
		rrsig_rdata_fields),
	TYPE("NSEC", TYPE_NSEC,
		read_nsec_rdata, write_generic_rdata, print_nsec_rdata,
		nsec_rdata_fields),
	TYPE("DNSKEY", TYPE_DNSKEY,
		read_dnskey_rdata, write_generic_rdata, print_dnskey_rdata,
		dnskey_rdata_fields),
	TYPE("DHCID", TYPE_DHCID,
		read_dhcid_rdata, write_generic_rdata, print_dhcid_rdata,
		dhcid_rdata_fields),
	TYPE("NSEC3", TYPE_NSEC3,
		read_nsec3_rdata, write_generic_rdata, print_nsec3_rdata,
		nsec3_rdata_fields),
	TYPE("NSEC3PARAM", TYPE_NSEC3PARAM,
		read_nsec3param_rdata, write_generic_rdata, print_nsec3param_rdata,
		nsec3param_rdata_fields),
	TYPE("TLSA", TYPE_TLSA,
		read_tlsa_rdata, write_generic_rdata, print_tlsa_rdata,
		tlsa_rdata_fields),
	...
	TYPE("CDNSKEY", TYPE_CDNSKEY,
		read_dnskey_rdata, write_generic_rdata, print_dnskey_rdata,
		cdnskey_rdata_fields),
	TYPE("OPENPGPKEY", TYPE_OPENPGPKEY,
		read_openpgpkey_rdata, write_generic_rdata, print_openpgpkey_rdata,
		openpgpkey_rdata_fields),
	TYPE("CSYNC", TYPE_CSYNC,
		read_csync_rdata, write_generic_rdata, print_csync_rdata,
		csync_rdata_fields),
	TYPE("ZONEMD", TYPE_ZONEMD,
		read_zonemd_rdata, write_generic_rdata, print_zonemd_rdata,
		zonemd_rdata_fields),
	TYPE("SVCB", TYPE_SVCB,
		read_svcb_rdata, write_svcb_rdata, print_svcb_rdata,
		svcb_rdata_fields),
	...
	TYPE("NID", TYPE_NID,
		read_nid_rdata, write_geneirc_rdata, print_nid_rdata,
		nid_rdata_fields),
	TYPE("L32", TYPE_L32,
		read_l32_rdata, write_generic_rdata, print_l32_rdata,
		l32_rdata_fields),
	TYPE("L64", TYPE_L64,
		read_l64_rdata, write_generic_rdata, print_l64_rdata,
		l64_rdata_fields),
	TYPE("LP", TYPE_LP,
		read_lp_rdata, write_lp_rdata, print_lp_rdata,
		lp_rdata_fields),
	TYPE("EUI48", TYPE_EUI48,
		read_eui48_rdata, write_generic_rdata, print_eui48_rdata,
		eui48_rdata_fields),
	TYPE("EUI64", TYPE_EUI64,
		read_eui64_rdata, write_generic_rdata, print_eui64_rdata,
		eui64_rdata_fields),
	...
	TYPE("URI", TYPE_URI,
		read_uri_rdata, write_generic_rdata, print_uri_rdata,
		uri_rdata_fields),
	TYPE("CAA", TYPE_CAA,
		read_caa_rdata, write_generic_rdata, print_caa_rdata,
		caa_rdata_fields),
	TYPE("AVC", TYPE_AVC,
		read_txt_rdata, write_generic_rdata, print_txt_rdata,
		avc_rdata_fields),
	TYPE("DLV", TYPE_DLV,
		read_dlv_rdata, write_generic_rdata, print_dlv_rdata,
		dlv_rdata_fields)
};
