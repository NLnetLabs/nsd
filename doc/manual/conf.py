...
copyright = f'2001–{year}, NLnet Labs'
author = 'NLnet Labs'
...
htmlhelp_basename = 'NSDUserManualdoc'
...
latex_documents = [
    (master_doc, 'NSDUserManual.tex', 'NSD User Manual',
     'NLnet Labs', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'NSDUserManual', 'NSD User Manual',
     author, 'NSDUserManual', 'One line description of project.',
     'Miscellaneous'),
]
