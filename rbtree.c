...
static void rbtree_delete_fixup (rbtree_t * rbtree, rbnode_t * child,
...
static void
change_parent_ptr (rbtree_t * rbtree, rbnode_t * parent, rbnode_t * old,
		   rbnode_t * new)
{
  if(parent == RBTREE_NULL)
    {
...
static void
change_child_ptr (rbnode_t * child, rbnode_t * old, rbnode_t * new)
{
...
int
rbtree_find_less_equal (rbtree_t * rbtree, const void *key,
			rbnode_t ** result)
{
  int r;
  rbnode_t *node;
